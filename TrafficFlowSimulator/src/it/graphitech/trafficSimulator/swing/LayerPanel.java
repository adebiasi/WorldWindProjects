...
public class LayerPanel extends JPanel
{
    ...
    private boolean isLayerToAvoid(Layer layer){
    	
    	if(layer.getName().compareTo("Stars")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("Atmosphere")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("Nasa Blue Marble Image")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("i-cubed Landsat")==0){
    		return true;
    	}    	
    	if(layer.getName().compareTo("comunetrento")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("Place Names")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("World Map")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("Scale bar")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("Compass")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("View Controls")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("NASA Blue Marble Image")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("Blue Marble (WMS) 2004")==0){
    		return true;
    	}
    	if(layer.getName().compareTo("MS Virtual Earth Aerial")==0){
    		return true;
    	}
    	if(layer.getName().startsWith("USDA")){
    		return true;
    	}
    	if(layer.getName().startsWith("Political")){
    		return true;
    	}
    	if(layer.getName().startsWith("USGS")){
    		return true;
    	}
