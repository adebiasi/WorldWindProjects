...
public class ShapefileLoader
{
    ...
    public int numPolygonsPerLayer = 5000;
    ...
    protected void addRenderablesForPolygons(Shapefile shp, List<Layer> layers)
    {
    	...
    	names.add("ALB");names.add("AUT");names.add("BEL");names.add("BIH");names.add("BGR");
    	names.add("DNK");names.add("IRL");names.add("EST");names.add("CZE");names.add("FRA");
    	names.add("DEU");names.add("GRC");names.add("HRV");names.add("HUN");names.add("ISL");
    	names.add("ITA");names.add("LVA");names.add("LTU");names.add("SVK");names.add("LIE");
    	names.add("LUX");names.add("MDA");names.add("MKD");names.add("MCO");names.add("NLD");
    	names.add("POL");names.add("PRT");names.add("ROM");names.add("SVN");names.add("ESP");
    	names.add("SWE");names.add("CHE");names.add("GBR");
        ...
        while (shp.hasNext())
        {
            try
            {
                ...
                {
                    layer.setName(record.getAttributes().getStringValue("CODE"));
                    //layer.setName(names.get(recordNumber));
                    //recordNumber++;
                    layers.add(layer);
                }
            }
