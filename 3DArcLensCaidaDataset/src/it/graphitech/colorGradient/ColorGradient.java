...
public class ColorGradient {
	...
	//static Color color1= new Color(30, 144, 255);
	...
	static public Color returnLogInterpolatedColor(double number, double minNumber, double maxNumber){
		
		
		 double ratio2 = (number-minNumber)/(maxNumber-minNumber);
		 double ratio = 1- Math.log(ratio2);
			System.out.println("number: "+number);
			System.out.println("ratio: "+ratio2);
			System.out.println("ratioLog: "+ratio);
		 //System.out.println("ratio: "+ratio);
		 //System.out.println(""+number+" -- "+minNumber+" --- "+maxNumber);
	     int red = (int) (color2.getRed() * ratio + color1.getRed() * (1 - ratio));
	     int green = (int) (color2.getGreen() * ratio + color1.getGreen() * (1 - ratio));
