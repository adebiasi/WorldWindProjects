...
public class GLSL {
  ...
  public GLSL(GL2 gl) {
    ...
    System.out.println("aaa vertexShaderSupported: "+vertexShaderSupported);
    System.out.println("aaa geomShaderSupported: "+geomShaderSupported);
   /*
  ...
  //
  //////////////////////////////////////////////////////////
  public void createGeometryShader(String shader
		  ,int inputGeometryType, int outputGeometryType
		  ) {
  ...
  //
  //////////////////////////////////////////////////////////
  public void updateGeometryShader(String shader
		  , int inputGeometryType, int outputGeometryType
		  ) {
	  this.gshaderSource = shader;
  ...
  //
  ///////////////////////////////////////////////////////////
  public void loadGeometryShader(java.io.File file
		  , int inputGeometryType, int outputGeometryType
		  )
  {
    ...
    createGeometryShader(gshaderSource
    		,inputGeometryType,outputGeometryType
    		);
  ...
  //
  ///////////////////////////////////////////////////////////
  public void updateGeometryShader(java.io.File file
		  , int inputGeometryType, int outputGeometryType
		  )
  {
//	  System.out.println("GEOMETRY SHADER");
    ...
    updateGeometryShader(gshaderSource
    		,inputGeometryType,outputGeometryType
    		);
