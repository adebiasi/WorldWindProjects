...
//            
		 ...
		 //   WMSTiledImageLayer layer = getWMSLayer("http://irs.gis-lab.info/?", "osm");            	   
    	 //   this.getWwd().getModel().getLayers().add(layer);
			
    	    
    	 //   WMSTiledImageLayer layer2 = getWMSLayer("http://www2.demis.nl/worldmap/wms.asp?", "Countries,Borders,Coastlines");            	   
    	 //  this.getWwd().getModel().getLayers().add(layer2);
    	   
    	    
    	  //  WMSTiledImageLayer layer2 = getWMSLayer("https://mb3is.megx.net/wms?", "boundaries");            	   
    	  //  this.getWwd().getModel().getLayers().add(layer2);
      ...
      //  protected AirspaceAttributes lastAttrs;
        ...
        protected void initialize(boolean includeStatusBar, boolean includeLayerPanel, boolean includeStatsPanel)
        {
			...
			if (includeLayerPanel) {
				...
				this.getContentPane().add(this.layerPanel, BorderLayout.EAST);
			}
...
*/
			...
			SharedVariables.wwd.getModel().getLayers().getLayerByName("Blue Marble May 2004").setEnabled(false);
			SharedVariables.wwd.getModel().getLayers().getLayerByName("Political Boundaries").setEnabled(true);
       ...
       //CARICO PUNTI
         ...
         */
         ...
         SharedVariables.nodes =new HashMap<String, Position>();     
         SharedVariables.city_to_city = new HashMap<String, Entry>();            
         dataPath = "./src/data/query_result_alberto2.csv";  
         ArrayList<Double> minmaxAvgTime = new ArrayList<Double>();
         minmaxAvgTime.add(0,Double.MAX_VALUE);         
         minmaxAvgTime.add(1,Double.MIN_VALUE);
         
         ArrayList<Integer> minmaxNumberCalls = new ArrayList<Integer>();
         minmaxNumberCalls.add(0,Integer.MAX_VALUE);         
         minmaxNumberCalls.add(1,Integer.MIN_VALUE);
         
         ArrayList<Integer> minmaxTotNumberCalls = new ArrayList<Integer>();
         minmaxTotNumberCalls.add(0,Integer.MAX_VALUE);         
         minmaxTotNumberCalls.add(1,Integer.MIN_VALUE);
         
         System.out.println("prima AVG TIME: "+minmaxAvgTime.get(0)+ " --- "+minmaxAvgTime.get(1));
        // loadFlowsDataFromFILENear(dataPath,SharedVariables.nodes,SharedVariables.entries,SharedVariables.city_to_city); 
         loadFlowsDataFromFILE_BigDataChallenge(dataPath,SharedVariables.nodes,SharedVariables.entries,SharedVariables.city_to_city,minmaxAvgTime,minmaxNumberCalls);
        System.out.println("BIG DATA CHALLENGE");
        System.out.println("AVG TIME: "+minmaxAvgTime.get(0)+ " --- "+minmaxAvgTime.get(1));
        System.out.println("NUMBER CALLS: "+minmaxNumberCalls.get(0)+ " --- "+minmaxNumberCalls.get(1));
         System.out.println("# nodi: "+SharedVariables.nodes.size());
         System.out.println("# archi: "+SharedVariables.city_to_city.size());
         insertAnnotations(wwd,SharedVariables.nodes,"BIG DATA CHALLENGE annotations");
         GeneratorOfRenderableObjects.GeneratorOfRenderableObjectsBIGDATACHALLENGE(wwd, SharedVariables.entries, SharedVariables.city_to_city, "all","BIG DATA CHALLENGE arcs",minmaxAvgTime,minmaxNumberCalls);
         GeneratorOfRenderableObjects.GeneratorOfRenderableObjectsOnFlatMapBIGDATACHALLENGE(wwd, SharedVariables.entries, SharedVariables.city_to_city, "all","FLAT MAP: BIG DATA CHALLENGE arcs",minmaxAvgTime,minmaxNumberCalls);
         ...
         SharedVariables.nodes =new HashMap<String, Position>();     
         SharedVariables.city_to_city = new HashMap<String, Entry>();            
         dataPath = "./src/data/BDC_time_Milano.csv";  
         minmaxAvgTime = new ArrayList<Double>();
         minmaxAvgTime.add(0,Double.MAX_VALUE);         
         minmaxAvgTime.add(1,Double.MIN_VALUE);
         
         minmaxNumberCalls = new ArrayList<Integer>();
         minmaxNumberCalls.add(0,Integer.MAX_VALUE);         
         minmaxNumberCalls.add(1,Integer.MIN_VALUE);
         
         minmaxTotNumberCalls = new ArrayList<Integer>();
         minmaxTotNumberCalls.add(0,Integer.MAX_VALUE);         
         minmaxTotNumberCalls.add(1,Integer.MIN_VALUE);
         
         System.out.println("prima AVG TIME: "+minmaxAvgTime.get(0)+ " --- "+minmaxAvgTime.get(1));
        // loadFlowsDataFromFILENear(dataPath,SharedVariables.nodes,SharedVariables.entries,SharedVariables.city_to_city); 
         loadFlowsDataFromFILE_BigDataChallengeWithTime(dataPath,SharedVariables.nodes,SharedVariables.entries,SharedVariables.city_to_city,minmaxAvgTime,minmaxNumberCalls, minmaxTotNumberCalls);
        System.out.println("BIG DATA CHALLENGE");
        System.out.println("AVG TIME: "+minmaxAvgTime.get(0)+ " --- "+minmaxAvgTime.get(1));
        System.out.println("NUMBER CALLS: "+minmaxNumberCalls.get(0)+ " --- "+minmaxNumberCalls.get(1));
         System.out.println("# nodi: "+SharedVariables.nodes.size());
         System.out.println("# archi: "+SharedVariables.city_to_city.size());
         insertAnnotations(wwd,SharedVariables.nodes,"BDC TIME annotations");
         GeneratorOfRenderableObjects.GeneratorOfRenderableObjectsBIGDATACHALLENGE_time
         (wwd, SharedVariables.entries, SharedVariables.city_to_city, "all","BDC TIME MILANO arcs",minmaxAvgTime,minmaxNumberCalls,minmaxTotNumberCalls);
         GeneratorOfRenderableObjects.GeneratorOfRenderableObjectsOnFlatMapBIGDATACHALLENGE_time
         (wwd, SharedVariables.entries, SharedVariables.city_to_city, "all","FLAT MAP: BDC TIME MILANO arcs",minmaxAvgTime,minmaxNumberCalls,minmaxTotNumberCalls);
 
         drawNodes(wwd,SharedVariables.nodes,"BDC TIME MILANO Nodes");
         */
         ...
         SharedVariables.nodes =new HashMap<String, Position>();     
         SharedVariables.city_to_city = new HashMap<String, Entry>();            
         dataPath = "./src/data/BDC_time_Napoli.csv";  
         minmaxAvgTime = new ArrayList<Double>();
         minmaxAvgTime.add(0,Double.MAX_VALUE);         
         minmaxAvgTime.add(1,Double.MIN_VALUE);
        ...
        System.out.println("NUMBER CALLS: "+minmaxNumberCalls.get(0)+ " --- "+minmaxNumberCalls.get(1));
         ...
         insertAnnotations(wwd,SharedVariables.nodes,"BDC TIME annotations");
         GeneratorOfRenderableObjects.GeneratorOfRenderableObjectsBIGDATACHALLENGE_time
         (wwd, SharedVariables.entries, SharedVariables.city_to_city, "all","BDC TIME NAPOLI arcs",minmaxAvgTime,minmaxNumberCalls,minmaxTotNumberCalls);
         
         GeneratorOfRenderableObjects.GeneratorOfRenderableObjectsOnFlatMapBIGDATACHALLENGE_time
         (wwd, SharedVariables.entries, SharedVariables.city_to_city, "all","FLAT MAP: BDC TIME NAPOLI arcs",minmaxAvgTime,minmaxNumberCalls,minmaxTotNumberCalls);
 
         drawNodes(wwd,SharedVariables.nodes,"BDC TIME NAPOLI nodes");
         /*
       //CARICO PUNTI
         SharedVariables.entries = new ArrayList<String>();
         SharedVariables.nodes =new HashMap<String, Position>();     
        ...
        */
        ...
        private static void drawNodes(WorldWindow wwd,HashMap<String, Position> nodes, String layerName){
        	RenderableLayer layer = new RenderableLayer();
            layer.setName(layerName);
            layer.setPickEnabled(false);
            layer.setMaxActiveAltitude(7000000);
            
            for(java.util.Map.Entry<String,Position> entry: nodes.entrySet()){
            	PointPlacemark pp = new PointPlacemark(entry.getValue());
                pp.setLabelText(entry.getKey());
                //pp.setValue(AVKey.DISPLAY_NAME,entry.getKey());
                pp.setAltitudeMode(WorldWind.CLAMP_TO_GROUND);
                PointPlacemarkAttributes attrs = new PointPlacemarkAttributes();
                attrs = new PointPlacemarkAttributes();
                attrs.setLabelColor("ff00ffff");
                attrs.setLineMaterial(Material.YELLOW);
                attrs.setUsePointAsDefaultImage(true);
                attrs.setScale(3d);
                attrs.setLabelOffset(new Offset(-5d, 2d, AVKey.PIXELS, AVKey.PIXELS));
...
//                           
        ...
        */   
        ...
        static public void loadFlowsDataFromFILE_BigDataChallengeWithTime(String dataPath,HashMap<String, Position> nodes,ArrayList<String> entries, 
        		HashMap<String, Entry> city_to_city,
        	...
        	try{
        		...
        		System.out.println("LINEA: "+strLine);
        			...
        			String[] data = strLine.split(";");
        			entry.setTime(data[0].trim());
        			entry.setFrom(data[1].trim());
        			...
        			entry.setTo(data[4].trim());
        			entry.setTo_lat(Double.parseDouble(data[5].replace(",",".").trim()));
        			entry.setTo_lon(Double.parseDouble(data[6].replace(",",".").trim()));
        			//System.out.println("OK" + i);
        			//entry.setEc_funding(Double.parseDouble(data[8].trim()));
        			
        			int number_calls = Integer.parseInt(data[7].trim());
        			double avg_time = Double.parseDouble(data[8].trim());
        			
        			int totNumberCalls = Integer.parseInt(data[9].trim());
        			double totAvgNumberCalls = Double.parseDouble(data[10].replace(",",".").trim());
        			
        			int totMinNumberCalls = Integer.parseInt(data[11].trim());
        			int totMaxNumberCalls = Integer.parseInt(data[12].trim());
        			
        			/*
        			boolean outlierNumberCall = Boolean.valueOf(data[11].trim());
        			boolean outlierAvgTime = Boolean.valueOf(data[12].trim());
        			
        			int totOutlierNumberCall = Integer.valueOf(data[13].trim());
        			int totOtlierAvgTime = Integer.valueOf(data[14].trim());
        			*/
        			int isOutliner = Integer.parseInt(data[14].trim());
        			
        			boolean outlierNumberCall = isOutliner==1;
        			int totOutlierNumberCall = Integer.valueOf(data[15].trim());
        			
        			System.out.println(number_calls+" - "+avg_time+ " - "+totNumberCalls+" - "+totAvgNumberCalls+" - "+totMinNumberCalls);
        			
        			
        			//entry.setTotOutlinerAvgTime(totOtlierAvgTime);
        			entry.setTotOutlinerNumberCalls(totOutlierNumberCall);
        			
        			entry.setNumber_calls(number_calls);
        			entry.setTotNumber_calls(totNumberCalls);
        			entry.setAvg_time(avg_time);
        			//entry.setRank(Integer.parseInt(data[9].trim()));
        			
        			entry.setOutlierNumberCall(outlierNumberCall);
        			//entry.setOutlierAvgTime(outlierAvgTime);
        			entry.setTotAvgNumber_calls(totAvgNumberCalls);
        			
        			entry.setTotMinNumberCalls(totMinNumberCalls);
        			entry.setTotMaxNumberCalls(totMaxNumberCalls);
        			
        			System.out.println("entry .... "+entry.getTotOutlinerAvgTime()+" .... "+entry.getTotOutlinerNumberCalls());
        		...
        		//	if(SharedVariables.showOnlyNearArc){
        			...
        			*/
        			...
        			if(totNumberCalls>SharedVariables.minNumCallsToFilter){
        				
        				
        				if(entry.getAvg_time()>minmaxAvgTime.get(1)){
            				minmaxAvgTime.set(1, entry.getAvg_time());
            			}
            			if(entry.getAvg_time()<minmaxAvgTime.get(0)){
            				minmaxAvgTime.set(0, entry.getAvg_time());
            			}
            			
            			if(entry.getNumber_calls()>minmaxNumberCalls.get(1)){
            				minmaxNumberCalls.set(1, entry.getNumber_calls());
            			}
            			if(entry.getNumber_calls()<minmaxNumberCalls.get(0)){
            				minmaxNumberCalls.set(0, entry.getNumber_calls());
            			}
            			
            			if(entry.getTotNumber_calls()>minmaxTotNumberCalls.get(1)){
            				minmaxTotNumberCalls.set(1, entry.getTotNumber_calls());
            			}
            			if(entry.getTotNumber_calls()<minmaxTotNumberCalls.get(0)){
            				minmaxTotNumberCalls.set(0, entry.getTotNumber_calls());
            			}
        			...
        			if(!nodes.containsKey(entry.getTo())){
        				...
        				nodes.put(entry.getTo(), p);	      		
        						...
        						String key = entry.getFrom() + "-" + entry.getTo()+ "-"+entry.getTime();
	        		if(!entries.contains(key)){
	        			entries.add(key);
	        			city_to_city.put(key, entry);
	        		}
	        		else{
	        			System.out.println("ESISTE GIA: "+ key);
	       				//Entry updated = city_to_city.get(key);
	       				//updated.setEc_funding(updated.getEc_funding() + entry.getEc_funding());
	       				//city_to_city.put(key, updated);
	       			}	
	        		...
	        		System.out.println(entry.getFrom()+" "+entry.getFrom_lat()+" "+entry.getFrom_lon()+" "+entry.getTo()+" "+entry.getTo_lat()+" "+entry.getTo_lon()+" "+entry.getNumber_calls()+" "+entry.getAvg_time());
        					}
        		//		}
        ...
        static public void loadFlowsDataFromFILE_BigDataChallenge(String dataPath,HashMap<String, Position> nodes,ArrayList<String> entries, 
        		HashMap<String, Entry> city_to_city,
        	...
        	try{
        		...
        		while ((strLine = br.readLine()) != null) {  
        			...
        			entry.setState(data[0].trim());
        			
        			entry.setFrom_lat(Double.parseDouble(data[1].replace(",",".").trim()));
        			entry.setFrom_lon(Double.parseDouble(data[2].replace(",",".").trim()));
        			
        			entry.setTo(data[3].trim());
        			entry.setTo_lat(Double.parseDouble(data[4].replace(",",".").trim()));
        			entry.setTo_lon(Double.parseDouble(data[5].replace(",",".").trim()));
        			//System.out.println("OK" + i);
        			//entry.setEc_funding(Double.parseDouble(data[8].trim()));
        			
        			entry.setNumber_calls(Integer.parseInt(data[6].trim()));
        			entry.setAvg_time(Double.parseDouble(data[7].trim()));
        			//entry.setRank(Integer.parseInt(data[9].trim()));
    ...
    {
    	//setupConfiguration();
        Main_STANDALONE_v3.start("Visual Exploration of Outgoing Calls from Italy - Alberto Debiasi - Fondazione Graphitech", AppFrame.class);
    }
    

	private static WMSTiledImageLayer getWMSLayer(String wmsURL, String layerName) {
	...
	static public void disablePlaceNames(){
		
	
	  PlaceNameLayer nameLayer = null;
	  List<PlaceNameService> nameServices = null;
	        ...
	        {
	        	System.out.println("---> "+s.getDataset());
	           
	                s.setEnabled(false);
	           if(s.getDataset().equals("topp:countries")){
	        	   s.setEnabled(true);
	           }
	        }
