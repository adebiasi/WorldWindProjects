...
import it.graphitech.smeSpire.Main_STANDALONE_v3;
...
public class FBOManager {
	...
	public void setup(DrawContext dc){
		if(!firstTime){
            ...
            h_window_in_pixels =((Component)Main_STANDALONE_v3.wwd).getSize().height;
            w_window_in_pixels =((Component)Main_STANDALONE_v3.wwd).getSize().width;
