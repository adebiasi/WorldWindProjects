...
//			 System.out.println("size 2: "+size);
		...
		if(e.getKeyChar()=='1'){
			SharedVariables.chooseColorConfigurations=1;			
				System.out.println("I'm showing avgTime of calls");
			}
		
	if(e.getKeyChar()=='2'){
		SharedVariables.chooseColorConfigurations=2;			
			System.out.println("I'm showing total calls");		
	}
if(e.getKeyChar()=='3'){
	SharedVariables.chooseColorConfigurations=3;			
		System.out.println("I'm showing outlines avgTime of calls");
	}
if(e.getKeyChar()=='4'){
	SharedVariables.chooseColorConfigurations=4;			
		System.out.println("I'm showing outlines total calls");
