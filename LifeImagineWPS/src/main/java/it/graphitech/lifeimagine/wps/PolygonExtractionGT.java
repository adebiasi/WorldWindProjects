...
public class PolygonExtractionGT implements RasterProcess {

    

    public PolygonExtractionGT() {
    ...
    public SimpleFeatureCollection execute(
            ...
            @DescribeParameter(name = "removeCollinear", description = "Remove Collinear: 0 = false, 1 = true", min = 0, defaultValue = "1") Integer removeCollinear,
            @DescribeParameter(name = "filterThreshold", description = "Filter Threshold", min = 0, defaultValue = "0.0") Double filterThreshold,
            @DescribeParameter(name = "filterMethod", description = "Filter Method: 0 = FILTER_MERGE_LARGEST, 1 = FILTER_MERGE_RANDOM, 2 = FILTER_DELETE", min = 0, defaultValue = "0") Integer filterMethod,
...
System.out.println("EXCECUTE PROCESS PolygonExtraction...");
        ...
        boolean remCollinear;
        if(removeCollinear.equals(1)){
        	remCollinear=true;
        }else{
        	remCollinear=false;
        }
        
        pb.setParameter("removeCollinear", remCollinear);  
        pb.setParameter("filterThreshold", filterThreshold);
      //FILTER_MERGE_LARGEST = 0;
        //FILTER_MERGE_RANDOM = 1;
        //FILTER_DELETE = 2;
        pb.setParameter("filterMethod", filterMethod);
        ...
        System.out.println("num polygons: "+prop.size());
