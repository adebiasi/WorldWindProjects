 ...
 * All Rights Reserved.
 */
package it.graphitech.layer.mercator;
 ...
 *
 * @author tag
 * @version $Id: MercatorTiledImageLayer.java 665 2012-06-26 20:43:22Z tgaskins $
 */
public abstract class MercatorTiledImageLayer extends AbstractLayer
{
    ...
    private double splitScale = 1.9; // TODO: Make configurable
        ...
        ArrayList<MercatorTextureTile> tiles)
    {
        ...
        com.jogamp.opengl.util.awt.TextRenderer textRenderer = OGLTextRenderer.getOrCreateTextRenderer(dc.getTextRendererCache(),
