 ...
 */
public class Polyline_old extends AVListImpl implements Renderable, OrderedRenderable, Movable, Restorable,
    MeasurableLength, ExtentHolder
{
    ...
    public Polyline_old(Iterable<? extends Position> positions)
    {
    ...
    public Polyline_old(Iterable<? extends LatLon> positions, double elevation)
    {
    ...
    protected void drawOrderedRenderable(DrawContext dc)
    {
        ...
        int r1=range.array()[0];
        int r2=range.array()[1];
        ...
        try
        {
            ...
            if (dc.isPickingMode()){
            	//System.out.println("is pickmode: "+(this.lineWidth + 8));
                gl.glLineWidth((float) this.lineWidth + 8);
            }
            else
            {
            	//System.out.println("not pick mode "+this.lineWidth );
            ...
            for (List<Vec4> span : this.currentSpans)
            {
                ...
                System.out.println("size: "+span.size());
