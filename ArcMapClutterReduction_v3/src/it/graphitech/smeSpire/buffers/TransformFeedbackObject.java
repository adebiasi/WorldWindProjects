...
public class TransformFeedbackObject {
	...
	int numTransformFeedbackBufferElements  = 100000;
	...
	public TransformFeedbackObject(GL2 gl) {
			/*
		this.gl = gl;
		feedback = IntBuffer.allocate(1);
		gl.glGenTransformFeedbacks(1, feedback);
		*/
		
		// Create transform feedback buffer
		this.gl = gl;
		tbo = IntBuffer.allocate(1);
	    ...
	    System.out.println("TBO: "+tbo.get(0));
	}
public int getNumTransformFeedbackBufferElements(){
	...
	public void initTransformFeedbackBuffer(){
		gl.glBindBuffer(GL2.GL_TRANSFORM_FEEDBACK_BUFFER, tbo.get(0));
	...
	public void bind() 
	{
	   // gl.glBindTransformFeedbackNV(GL2.GL_TRANSFORM_FEEDBACK_NV, feedback.get(0));
		 ...
		 gl.glBindBufferBase(GL2.GL_TRANSFORM_FEEDBACK_BUFFER, 0, tbo.get(0));
	}
