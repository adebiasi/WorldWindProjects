...
//uniform float lensDiameter = 150;
uniform float lensDiameter;
uniform int numElements;
// Options
//uniform int numElements = 501;
...
vec4 createVec4(float indexLine, float rest, int type){
vec4 newVec;
  newVec.x=1;
newVec.y=indexLine;
newVec.z=rest;
...
type=4;
result = createVec4(indexLine,rest ,type); EmitVertex();
}
